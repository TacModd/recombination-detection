# takes a pattern object returns a partition object, which includes the 
# number of unique partition patterns, their ids, their indices, and 
# their counts in a list of lists
get.partitions = function(patterns){
